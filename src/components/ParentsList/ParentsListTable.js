        ...
        <tbody>
          {ProductListDemo.map((data, index) => (
            ...
            >
              ...
              <td class='whitespace-nowrap  px-4 py-4 sm:px-5'>
              {['Businessman', 'Banker', 'Farmer'].sort(() => Math.random() - 0.5)[1]}
              </td>
         
           
              <td class='whitespace-nowrap  px-4 py-4 sm:px-5'>Mymensingh</td>
...
export default ParentsListTable;
