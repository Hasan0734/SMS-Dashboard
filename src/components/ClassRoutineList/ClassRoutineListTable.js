        ...
        <tbody>
          {ProductListDemo.map((data, index) => (
            ...
            >
              ...
              <td className='whitespace-nowrap  px-3 py-3 sm:px-5'>
              {['One', 'Two', 'Three'].sort(() => Math.random() - 0.5)[1]}
              </td>
              ...
              <td class='whitespace-nowrap  px-3 py-3 sm:px-5'>
                {
                  ['Mustofa kamal', 'Jonshon', 'Karim Hasan', 'Rashida Begum'].sort(
                    () => Math.random() - 0.5
                  )[1]
                }
              </td>
              ...
              <td class='whitespace-nowrap  px-3 py-3 sm:px-5'>
               {new Date().getDate() + index}/05/2023
              </td>
...
export default ClassRoutineListTable;
